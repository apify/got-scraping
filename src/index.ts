...
const gotScraping = got.extend(SCRAPING_DEFAULT_OPTIONS, {
...
// Overriding the defaults by merging its defaults and our scraping defaults.
// gotScraping.defaults.options = new Options(SCRAPING_DEFAULT_OPTIONS);
